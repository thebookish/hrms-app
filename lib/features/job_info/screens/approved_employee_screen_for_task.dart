...
class ApprovedEmployeeListScreen extends ConsumerStatefulWidget {
  const ApprovedEmployeeListScreen({super.key});

  @override
  ConsumerState<ApprovedEmployeeListScreen> createState() => _ApprovedEmployeeListScreenState();
}

class _ApprovedEmployeeListScreenState extends ConsumerState<ApprovedEmployeeListScreen> {
  String _searchQuery = '';
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => AssignTaskScreen(employeeEmail: emp.email),
                            ),
                          );
                        },
                      ),
